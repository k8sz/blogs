...
subtitle: 使用 Let's Encrypt 实现
date: 2019-10-08
tags: ["kubernetes", "ingress","nginx-ingress","Cert manager"]
keywords: ["kubernetes","ingress"]
slug: kubernetes-ingress-https
gitcomment: true
...
* 参考：http://docs.cert-manager.io/en/latest/getting-started/install/kubernetes.html
